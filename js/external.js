...
var pricePerDay = prompt("How much is the daily rental per movie?");
...
var totalCost = (parseInt(littleMermaidDays) + parseInt(brotherBearDays) + parseInt(herculesDays)) * pricePerDay;
alert("You will pay " + "$" + totalCost);
...
var googleRate = prompt("How much do you make per hour at Goodle?");
var googleHours = prompt("How many hours did you work at Google?");

var amazonRate = prompt("How much do you make per hour at Amazon?");
var amazonHours = prompt("How many hours did you work at Amazon?");

var facebookRate = prompt("How much do you make per hour at Facebook?");
var facebookHours = prompt("How many hours did you work at Facebook?");

var totalPayment = facebookHours * facebookRate;
    totalPayment += googleHours * googleRate;
    totalPayment += amazonHours * amazonRate;

alert("You will receive" + "$" + totalPayment + " for this week.");
...
alert("You will receive " + "$" + totalPayment + " this week.");
...
//THIS IS ANOTHER WAY OF WRITING IF, ELSE:
//var discountStatus = (true) ? alert("Discount applied!") : alert("No discount.");
